...
<body class="stretched page-transition" data-loader-html="<img class='infinite animated pulse' src='res/newimage/mylogo.png' width='300'>">
    ...
    <div id="wrapper" class="clearfix">
            ...
            <div id="header-wrap">
                <div class="container px-0">
                    <div class="header-row">
						...
						============================================= -->
                        <div id="logo">
                            <a href="index.html" class="standard-logo"><img src="{{asset('res/newimage/goldlogo.png')}}" style="height:50px;"></a>
                            <a href="index.html" class="retina-logo"><img src="{{asset('res/newimage/goldlogo.png')}}" style="height:50px;"></a>
                        </div>
                        <!-- #logo end -->
        ...
        <section id="slider" class="slider-element slider-parallax page-section min-vh-60 min-vh-md-100 include-header">
            <div class="slider-inner" style="background: url('res/newimage/tanaman.jpg') center center no-repeat; background-size: cover;">
                ...
                <div class="top-right" style="margin-top: 0px !important">
                    <div class="text-center py-5 py-md-0">
                        ...
                        <nav class="custom-hero-nav" style="float:right;top :0px;margin-top: 35px !important">
                            <ul class="one-page-menu" data-easing="easeInOutExpo" data-speed="1300" data-offset="60" id="navbartop">
                                <li class="active"><a href="#" data-href="#slider">Home</a></li>
                                <li><a href="#" data-offset="56" data-href="#about">About Me</a></li>
                                <li><a href="#" data-href="#mypost">My Post</a></li>
                                <li><a href="#" data-href="#testimonial">My Quote</a></li>
                                <!--  <li><a href="#" data-href="#testimonial">Testimonial</a></li> -->
                                <li><a href="#" data-href="#myphoto" style="margin-right:20px;">My Photo</a></li>
                            </ul>
                        </nav>
...
<span style = "font-size:20px; text-align: center !important;" >Kiss Kiss From </span><br><h3 style = "font-size:25px;">Nella</h3>
            ...
            <div class="center">
                ...
                <div id="testimonial" class="section page-section parallax pb-0 dark clearfix" style="background-image: url('res/newimage/quotes.jpg'); background-size: cover;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
                                ...
                                <div class="slider-wrap">
                                    <div class="slide">
                                        <div class="testi-content">
                                            <p>Collaboratively enhance intermandated innovation via cutting-edge core competencies. Professionally extend covalent e-markets and mission-critical communities. Dramatically communicate revolutionary web services
                                                for interactive synergy. Synergistically.</p>
                                    ...
                                    <div class="slide">
                                        <div class="testi-content">
                                            <p>Intrinsicly synergize excellent content whereas user friendly action items. Rapidiously transition multimedia based information after top-line alignments. Proactively e-enable front-end e-commerce without mission-critical
                                                customer service.</p>
                                            <div class="testi-meta">
                                                Collis Ta'eed
                                    ...
                                    <div class="slide">
                                        <div class="testi-content">
                                            <p>Compellingly engage multimedia based niche markets via value-added manufactured products. Competently formulate goal-oriented content for installed base users. Uniquely leverage other's granular ROI without
                                                24/365 collaboration and idea-sharing.</p>
                                            <div class="testi-meta">
                                                John Doe
					...
					============================================= -->
                    <div id="oc-clients" class="owl-carousel owl-carousel-full image-carousel carousel-widget topmargin-lg mb-0" data-margin="0" data-nav="false" data-pagi="false" data-autoplay="3000" data-items-xs="3" data-items-sm="3" data-items-md="5" data-items-lg="6"
                        data-items-xl="6" data-loop="true" style="z-index: 2; padding: 30px 0; border-top: 1px solid rgba(255,255,255,0.15);">

                        <!-- Clients items
						============================================= -->
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/1.png')}}" alt="Brands"></a>
                        </div>
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/4.png')}}" alt="Brands"></a>
                        </div>
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/6.png')}}" alt="Brands"></a>
                        </div>
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/2.png')}}" alt="Brands"></a>
                        </div>
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/3.png')}}" alt="Brands"></a>
                        </div>
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/5.png')}}" alt="Brands"></a>
                        </div>
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/7.png')}}" alt="Brands"></a>
                        </div>
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/8.png')}}" alt="Brands"></a>
                        </div>
                        <div class="oc-item">
                            <a href="#"><img src="{{asset('res/demos/barber/images/clients/9.png')}}" alt="Brands"></a>
                        </div>
                ...
                <div class="section bg-transparent mb-0 topmargin-sm clearfix">
                    ...
                    <div class="container clearfix" id="myphoto">
                        ...
                        <div class="heading-block center">
                            <img src="{{asset('res/demos/barber/images/icons/team.svg')}}" alt="Image" height="50" style="margin-bottom: 20px">
                        ...
                        <div class="row">
                                ...
                                <div class="team">
                                    ...
                                    <div class="team-desc">
                                        <div class="team-title">
                                            <h4>John Doe</h4><span>Expert</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 bottommargin">
                                <div class="team">
                                    <div class="team-image">
                                        <img src="{{asset('res/demos/barber/images/barbers/2.jpg')}}" alt="Josh Thompson">
                                        <div class="bg-overlay">
                                            <div class="bg-overlay-content p-2 flex-column-reverse justify-content-between align-items-center">
                                                <div class="d-flex mb-3" data-hover-animate="fadeInUp" data-hover-animate-out="fadeOutDown" data-hover-speed="400" data-hover-parent=".team">
                                                    <a href="#" class="social-icon si-rounded si-colored si-small si-facebook" title="Facebook">
                                    ...
                                    <div class="team-desc">
                                        <div class="team-title">
                                            <h4>Josh Thompson</h4><span>Barber</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 bottommargin">
                                <div class="team">
                                    ...
                                    <div class="team-desc">
                                        <div class="team-title">
                                            <h4>Mary Jane</h4><span>Junior Barber</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
