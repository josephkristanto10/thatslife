    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="content" style="border-top: 8px solid #ffffff">
            ...
            <div class="content-wrap py-0">
                ...
                <center>
                    <div class="container"
                        style="width:80%;background-color:transparent;padding-bottom:40px;">
                        <div class="row" style="heigth:500px;margin-bottom:20px;height:100%;position:relative;">
                            <div class="greetings" style="margin:auto;width:100%;background-color:white;height:400px;height:100%;position:relative;">
                                    ...
                                    <?php $myassets =  asset('gambarstory/'.$story->image);?>
                                        ...
                                        <br><br> <br><span
                                            ...
                                            <div style="text-align:left;padding-left:20px;"> <span
                                                    style=" text-align:left !important;font-size:20px;padding-left:20px !important;">I'm
                                                    Nella, I write this story to share about my travel experience. So,
                                                    you are on my <span style='font-size:19px;color:#BF9456;'>{{$story->title}}</span><span style='font-size:20px;'> &
                                                        Because you have click this post, so lets begin... </span></div>
                                        </span>
                                        <br><br>
...
<?php
                ...
                <a href="#" style="margin-top:200px;" class="button button-full bg-color font-secondary center"
